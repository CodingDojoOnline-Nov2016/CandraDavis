...
SELECT countries.name, COUNT(cities.id) AS total_num_cities
FROM countries
...
SELECT countries.name, cities.district AS district_name, cities.name AS city, cities.population
FROM countries
JOIN cities ON countries.id = cities.country_id
...
SELECT countries.region, COUNT(countries.id) AS num_in_region
FROM countries
GROUP BY countries.region
ORDER BY num_in_region DESC
